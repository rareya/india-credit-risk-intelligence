...
-- Business Question: recent_enquiries_6m is 12.3% null and gets
--                    median-imputed -- does that visibly shift
--                    predicted risk for those borrowers versus
--                    borrowers with real enquiry data?
